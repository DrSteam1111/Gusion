...
{
	m_VertexArray = Gusion::VertexArray::Create();
	...
	Gusion::Ref<Gusion::VertexBuffer> vertexBuffer = Gusion::VertexBuffer::Create(vertices, sizeof(vertices));
	...
	Gusion::Ref<Gusion::IndexBuffer> indexBuffer = Gusion::IndexBuffer::Create(indices, sizeof(indices) / sizeof(uint32_t));
	m_VertexArray->SetIndexBuffer(indexBuffer);

	m_SquareVA = Gusion::VertexArray::Create();
	...
	Gusion::Ref<Gusion::VertexBuffer> squareVB = Gusion::VertexBuffer::Create(squareVertices, sizeof(squareVertices));
	squareVB->SetLayout({
		{ Gusion::ShaderDataType::Float3, "a_Position" },
	...
	Gusion::Ref<Gusion::IndexBuffer> squareIB = Gusion::IndexBuffer::Create(squareIndices, sizeof(squareIndices) / sizeof(uint32_t));
...
void ExampleLayer::OnUpdate(Gusion::Timestep ts)
{
	// Update
...
void ExampleLayer::OnEvent(Gusion::Event& e)
{
